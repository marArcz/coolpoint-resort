...
const Reservations = ({ reservations }: Props) => {
    const { data, setData, get, processing, errors, reset } =
        useForm<ISearchAvailability>({
            date_from: undefined,
            date_to: undefined,
            adults: 1,
            children: 0,
    ...
    const nights: number =
        data.date_from && data.date_to
            ? differenceInDays(addDays(data.date_to, 1), data.date_from)
            : 0;
    ...
    return (
        <AppLayout>
            ...
            <section className="pb-16 container-padded pt-28">
                            ...
                            <div className="w-full font-normal">
                                <div className=" text-left bg-gray-50 border-b border-gray-200">
                                    <div className="lg:grid lg:grid-cols-5 hidden  items-center gap-4 bg-secondary text-white ">
                                        ...
                                        <div className="px-6 py-4 col-span-1 text-left">
                                            Payment
                                        </div>
                                    </div>
                                    {/* rows */}
                                            ...
                                            >
                                                <div className="grid lg:grid-cols-5 grid-cols-4 items-center gap-4 group-hover:bg-gray-500/10 text-gray-900 border-b border-gray-300 py-4">
                                                    <div className="px-6 py-2 lg:py-4 col-span-full lg:col-span-1">
                                                        <p className="text-primary font-medium mb-2 block lg:hidden">
                                                            Reservation
                                                        </p>
                                                        <p className="mb-1">
                                                            #
                                                    ...
                                                    <div className="px-6 py-2 lg:py-4 col-span-2 lg:col-span-1 text-lg">
                                                        <p className="text-primary font-medium mb-2 block lg:hidden text-sm">
                                                            Total
                                                        </p>
                                                    ...
                                                    <div className="px-6 py-2 lg:py-4 col-span-2 lg:col-span-1">
                                                        ...
                                                        "pending" ? (
                                                            ...
                                                            <p
                                                                className={`font-medium ${reservation.status == "Approved" && reservation.isPaid ? "text-green-700" : "text-gray-600"}`}
                                                            >
                                                                {
                                                                    reservation.mStatus
                                                                }
            ...
            <section className="py-16 container-padded">
                ...
                <div className="mt-7 font-light text-lg">
                    <p>
                        Select the dates of your reservations and the number of
                        people to accomodate.
                    </p>
                </div>
                <div className="flex mt-8 flex-wrap gap-y-10">
                    ...
                    <div className="flex-grow lg:px-10">
                                ...
                                {data.date_from && data.date_to && (
                                    <div className="flex items-center">
                                        <input
                                            type="text"
                                            value={nights}
                                            className="w-full text-end border-0 pointer-events-none"
                                            readOnly
                                        />
                                        <span>
                        ...
                        <PrimaryButton
                            ...
                            className="w-full text-center mt-12 py-[14px] justify-center"
                            disabled={
                                data.adults == 0 ||
