...
import { IAddReservation, IReservation, IRoom, ISearchAvailability } from '@/types/models'
...
const CreateRoomReservation = ({ reservations = [], dateFrom, dateTo, adults = 1, children = 0,room }: Props) => {
        ...
        <AppLayout>
            ...
            <section className="py-16 container-padded">
                <HeadingTitle reverse>
                    <h2 className='text-4xl font-serif font-semibold'>Book Room</h2>
                </HeadingTitle>
                ...
                <div className="flex flex-wrap gap-y-10 justify-center mt-8">
                    <div className='w-max'>
                        <div className="text-end">
                            <PrimaryButton onClick={resetCalendar} className='text-sm mb-2'>Clear Selection</PrimaryButton>
                        </div>
                        <Calendar
                            mode="range"
                            numberOfMonths={2}
